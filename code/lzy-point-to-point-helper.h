 ...
 */
#ifndef LZY_POINT_TO_POINT_HELPER_H
#define LZY_POINT_TO_POINT_HELPER_H
 ...
 * "mixins".
 */
class LzyPointToPointHelper : public PcapHelperForDevice,
...
public:
   ...
   * point networks.
   */
  LzyPointToPointHelper ();
  virtual ~LzyPointToPointHelper () {}
