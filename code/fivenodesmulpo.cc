...
main (int argc, char *argv[])
{
  ...
  sw->SetNodeType(1);
  sw->m_switch->Set(0.5,1024*200,0);
  sw->m_switch->SetPO(true);
  ...
  pointToPoint.SetQueue("ns3::MultipleQueue","useqCnt",StringValue ("2"),"dequeueType",StringValue("0"),"po",StringValue("1"),"enqueueType",StringValue("1"));
  ...
  //tchFifo.SetRootQueueDisc ("ns3::FifoQueueDisc","MaxSize", StringValue ("2021p"));
  tchFifo.Install(devices02);
  tchFifo.Install(devices12);
  tchFifo.Install(devices23);
  tchFifo.Install(devices24);
