...
#ifndef LZY_POINT_TO_POINT_REMOTE_CHANNEL_H
#define LZY_POINT_TO_POINT_REMOTE_CHANNEL_H
 ...
 * method and uses an MPI Send operation instead.
 */
class LzyPointToPointRemoteChannel : public LzyPointToPointChannel
{
public:
  /**
   ...
   */
  virtual bool TransmitStart (Ptr<const Packet> p, Ptr<LzyPointToPointNetDevice> src,
                              Time txTime);
};
