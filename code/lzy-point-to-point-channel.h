...
#ifndef LZY_POINT_TO_POINT_CHANNEL_H
#define LZY_POINT_TO_POINT_CHANNEL_H
...
class LzyPointToPointNetDevice;
class Packet;
 ...
 * \see TransmitStart
 */
class LzyPointToPointChannel : public Channel 
{
public:
  /**
   ...
   */
  LzyPointToPointChannel ();

  /**
   * \brief Attach a given netdevice to this channel
   * \param device pointer to the netdevice to attach to the channel
   */
  void Attach (Ptr<LzyPointToPointNetDevice> device);
   ...
   */
  virtual bool TransmitStart (Ptr<const Packet> p, Ptr<LzyPointToPointNetDevice> src, Time txTime);
   ...
   */
  Ptr<LzyPointToPointNetDevice> GetLzyPointToPointDevice (std::size_t i) const;
...
protected:
   ...
   * specified link
   */
  Ptr<LzyPointToPointNetDevice> GetSource (uint32_t i) const;
   ...
   * the specified link
   */
  Ptr<LzyPointToPointNetDevice> GetDestination (uint32_t i) const;
...
public:
    ...
    Ptr<LzyPointToPointNetDevice> m_src;   //!< First NetDevice
    Ptr<LzyPointToPointNetDevice> m_dst;   //!< Second NetDevice
  };
