...
class LzyDropTailQueue : public Queue<Item>
{
public:
  /**
...
template <typename Item>
TypeId
LzyDropTailQueue<Item>::GetTypeId (void)
{
  static TypeId tid = TypeId (("ns3::LzyDropTailQueue<" + GetTypeParamName<LzyDropTailQueue<Item> > () + ">").c_str ())
    .SetParent<Queue<Item> > ()
    .SetGroupName ("Network")
    .template AddConstructor<LzyDropTailQueue<Item> > ()
...
template <typename Item>
LzyDropTailQueue<Item>::LzyDropTailQueue () :
  Queue<Item> (),
  NS_LOG_TEMPLATE_DEFINE ("LzyDropTailQueue")
{
...
template <typename Item>
bool
LzyDropTailQueue<Item>::Enqueue (Ptr<Item> item)
{
...
template <typename Item>
Ptr<Item>
LzyDropTailQueue<Item>::Dequeue (void)
{
  NS_LOG_FUNCTION (this);
...
template <typename Item>
Ptr<Item>
LzyDropTailQueue<Item>::Remove (void)
{
  NS_LOG_FUNCTION (this);
...
template <typename Item>
Ptr<const Item>
LzyDropTailQueue<Item>::Peek (void) const
{
  NS_LOG_FUNCTION (this);
...
extern template class LzyDropTailQueue<Packet>;
extern template class LzyDropTailQueue<QueueDiscItem>;
