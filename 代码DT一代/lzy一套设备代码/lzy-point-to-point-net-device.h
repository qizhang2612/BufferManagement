...
#ifndef LZY_POINT_TO_POINT_NET_DEVICE_H
#define LZY_POINT_TO_POINT_NET_DEVICE_H
 ...
 */
class LzyPointToPointNetDevice : public NetDevice
{
public:
  /**
   ...
   */
  virtual ~LzyPointToPointNetDevice ();
   ...
   */
  bool Attach (Ptr<LzyPointToPointChannel> ch);
...
private:
   ...
   */
  LzyPointToPointNetDevice& operator = (const LzyPointToPointNetDevice &o);
   ...
   * \param o Other NetDevice
   */
  LzyPointToPointNetDevice (const LzyPointToPointNetDevice &o);
...
private:
   ...
   * attached.
   */
  Ptr<LzyPointToPointChannel> m_channel;
